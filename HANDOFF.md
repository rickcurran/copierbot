...
- `orchestrator.py` publishes generated run folders to Mastodon/Bluesky/WordPress.
...
- Mastodon + Bluesky posts append disclosure line at publish time.
...
```zsh
#!/bin/zsh
cd /Users/rickcurran/Documents/Github/copierbot
exec /Users/rickcurran/Documents/Github/copierbot/.venv/bin/python dashboard.py
```
